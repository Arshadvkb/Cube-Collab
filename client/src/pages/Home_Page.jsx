...
import { Layers, FileText, Users, Shield, ArrowRight, CheckCircle2 } from 'lucide-react';
          ...
          <div className="h-[400px] md:h-[600px] bg-gray-50 flex">
            ...
            <div className="flex-1 p-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="h-32 bg-white rounded-xl border border-gray-200 p-4 shadow-sm flex flex-col justify-between">
            ...
            {[
              {
                ...
                description: "Write beautifully formulated documents with lists, headers, code blocks, and embedded media using our intuitive rich text editor."
              },
              {
                icon: <Users size={24} className="text-purple-600" />,
                title: "Real-time Collaboration",
                description: "Work together seamlessly. Share your documents instantly or keep them private to your own workspace as you develop your ideas."
              },
              {
                icon: <Layers size={24} className="text-indigo-600" />,
                title: "Organized Workspace",
                description: "Keep all your thoughts, projects, and notes elegantly organized in one dashboard. Never lose track of an important document again."
              },
              {
      ...
      <section className="bg-blue-600 py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-3xl">
          ...
          <p className="text-xl text-blue-100 mb-10">
            Join thousands of teams who are already using Cube Collab to centralize their knowledge and collaborate faster.
          </p>
          <button 
            onClick={() => navigate('/register')}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-xl font-bold text-white">Cube Collab</span>
              </div>
              <p className="max-w-sm">
                Empowering teams to create, organize, and collaborate on knowledge beautifully.
              </p>
            </div>
            <div>
