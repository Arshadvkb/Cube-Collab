      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto w-full">
        <header className="bg-white dark:bg-gray-900 px-8 py-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center sticky top-0 z-10">
          <div className="flex items-center gap-4">
            ...
            <span className={`text-xs px-2 py-1 rounded-full font-medium ${document?.isPublic ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300'}`}>
          ...
          {error ? (
            ...
            <div className="bg-white dark:bg-gray-900 p-10 md:p-14 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <div 
                ...
                dangerouslySetInnerHTML={{ __html: (typeof document?.content === 'string' ? document.content : '') || '<p class="text-gray-400 dark:text-gray-500 italic">No content</p>' }}
              />
            </div>
          )}
        </section>
